...
namespace Module_7
{
    ...
    public class Student : Person
    {
        ...
        //Adding a stack object called grades to hold students' scores:
    ...
    public class Course
    {
        ...
        {
            int counter=1;
            foreach (Student st in students) //Between these paranthesis ArrayList object is cast to Student object
            {
